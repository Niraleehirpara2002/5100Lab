...
public class DatabaseConnector {
    ...
    //U-Update
    public static void updatePatient(Patient oldPatient, Patient newPatient, Patient updatedPatient){
        String query ="UPDATE patient SET fname = ?, lname = ?, age = ?, email = ?, message = ?, gender = ?, patient_type = ?";
